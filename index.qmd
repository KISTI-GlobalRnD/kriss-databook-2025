...
::: {.callout-note}
## 빌드/접속 안내
- 기본 미리보기(`quarto preview`)는 웹사이트 버전입니다.  
- 북 프로필(`quarto preview --profile book`)은 챕터 넘버링/사이드바가 포함됩니다.  
- GitHub Pages 배포 시 `…/website/`와 `…/book/` 경로로 나뉘어 게시됩니다(gh-pages 기준).  
:::
...
- 웹 사이트: <https://kisti-globalrnd.github.io/kriss-databook-2025/website/>
- 북 (챕터형): <https://kisti-globalrnd.github.io/kriss-databook-2025/book/>
:::
...
1. Review the **문서 안내 / Document Guide** section (`index`, `research_overview`, `strategy_execution`) to
   ...
   - Drafting new chapters? Start with `authoring_notes` for the distribution-ready writing rules.
