...
본 절에서는 한국표준과학연구원과의 벤치마킹 대상으로 선정된 10개 핵심 기관을 중심으로, 연구 영역별 정책부합성을 비교·진단하였다. 목적은 각 기관이 보유한 측정표준 역량 기반 연구 활동이 정책적 수요와 얼마나 밀접하게 연계되어 있는지를 정량적으로 파악하는 데 있다.
...
![CIPM Strategy 2030+](Final_Report_MD/report_assets/CIPM_strategy_2030.png){#fig-cipm-strategy-2030}
...
![기관별 정책부합 연구 수 및 점유율 비교 (Full Counting)](Final_Report_MD/report_assets/00_by_institution_policy_alignment_count_and_share_full_counting.png){#fig-policy-alignment-count-share}
...
![기관별 정책부합 연구 비율 비교 (Full Counting)](Final_Report_MD/report_assets/00_by_institution_policy_alignment_share_full_counting.png){#fig-policy-alignment-share}
...
![전체 영역: 기관별 카테고리 정책부합 논문비율](Final_Report_MD/report_assets/02_overall_by_institution_policy_alignment_ratio_by_category.png){#fig-policy-category-overall}
...
![기관별 정책 카테고리별 연구 집중도(RTA)](Final_Report_MD/report_assets/00_by_institution_policy_alignment_rta_by_category.png){#fig-policy-category-rta}
...
![화학소재측정 영역: 기관별 카테고리 정책부합 논문비율](Final_Report_MD/report_assets/02_chemical_materials_by_institution_policy_alignment_ratio_by_category.png)
:::

::: {.carousel-slide}
<div class="slide-title">바이오의료측정</div>

![바이오의료측정 영역: 기관별 카테고리 정책부합 논문비율](Final_Report_MD/report_assets/02_biomedical_by_institution_policy_alignment_ratio_by_category.png)
:::

::: {.carousel-slide}
<div class="slide-title">양자기술</div>

![양자기술 영역: 기관별 카테고리 정책부합 논문비율](Final_Report_MD/report_assets/02_quantum_by_institution_policy_alignment_ratio_by_category.png)
:::
:::
