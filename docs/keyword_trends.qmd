...
description: "Interactive plot of top-ranked keywords by research cluster over time."
page-title: false
numbered: false
format:
  html:
...
Use the selector to switch between clusters while the legend lets you toggle individual keyword curves
on and off. All data are sourced from the comprehensive keyword time-series dataset
generated after term canonicalisation.
